...
void drive(float dt, float *fRoll, float *fYaw, float *fPitch,
           float *fPosX, float *fPosY, float *fPosZ, float *fVT,
           float fJoyX, float fJoyY, float *fVTx, float *fVTy,
           float *fVTz);
...
class ZFXMCAircraft : public ZFXMovementController  {
   public:
      ...
      float GetSpeedKts(void)  { return m_fVT; }
