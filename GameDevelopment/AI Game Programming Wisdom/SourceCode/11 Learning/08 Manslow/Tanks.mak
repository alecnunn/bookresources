...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "Tanks - Win32 Debug"
RSC=rc.exe
MTL=mktyplib.exe
CPP=cl.exe
...
CLEAN : 
	...
	-@erase ".\Release\CUnconditionalDistribution.obj"
	-@erase ".\Release\CWorld.obj"
	-@erase ".\Release\CConditionalDistribution.obj"
...
LINK32_OBJS= \
	...
	"$(INTDIR)/Tanks.obj" \
	"$(INTDIR)/CTank.obj" \
	"$(INTDIR)/CUnconditionalDistribution.obj" \
	"$(INTDIR)/CWorld.obj" \
	"$(INTDIR)/CConditionalDistribution.obj" \
	"$(INTDIR)/TanksDoc.obj" \
	"$(INTDIR)/CMLP.obj" \
	"$(INTDIR)/MainFrm.obj" \
...
CLEAN : 
	...
	-@erase ".\Debug\CUnconditionalDistribution.obj"
	-@erase ".\Debug\Tanks.obj"
	-@erase ".\Debug\CTank.obj"
	-@erase ".\Debug\CConditionalDistribution.obj"
...
SOURCE=.\CUnconditionalDistribution.cpp
DEP_CPP_CUNCO=\
	".\StdAfx.h"\
	".\CUnconditionalDistribution.h"\
	

"$(INTDIR)\CUnconditionalDistribution.obj" : $(SOURCE) $(DEP_CPP_CUNCO)\
 "$(INTDIR)" "$(INTDIR)\Tanks.pch"
...
SOURCE=.\CConditionalDistribution.cpp
...
"$(INTDIR)\CConditionalDistribution.obj" : $(SOURCE) $(DEP_CPP_CCOND)\
 "$(INTDIR)" "$(INTDIR)\Tanks.pch"
