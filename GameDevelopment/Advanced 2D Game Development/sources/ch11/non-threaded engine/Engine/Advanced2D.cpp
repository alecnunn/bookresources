...
//***** ADD TO ENGINE CODE LISTING IN CHAPTER 1
...
//***CHAPTER 5 - initialize DirectInput
		p_input = new Input(this->getWindowHandle());

//***CHAPTER 6 - init audio system
		//create audio system
		audio = new Audio();
