...
--=======================================
-- filename:  GUI_MovingTrack.lua
-- author:    Nick Carlson
-- created:   March 3, 2005
-- descrip:   AI chases a player's position
--=======================================
...
--=======================================
-- function:  MovingTrackSetTravelDirection(indx, tX, tY)
...
--=======================================
-- function:  MovingTrackCasualtyCheck()
-- author:    Nick Carlson
-- created:   February 11, 2005
-- returns:   nothing (process)
...
--=======================================
-- function:  MovingTrackDrawShip(myRot, x, y)
-- author:    Paul Schuytema
-- created:   February 1, 2004
-- returns:   nothing (process)
...
--y is the Y coordinate of the player's ship
    ...
    if alive == "yes" then
        MovingTrackCasualtyCheck()
    end
end


--Initial run sets the event handler
SetEventHandler("MovingTrackEvent")


--Event handler
function MovingTrackEvent(id, eventCode)
    ...
    if eventCode == GUI_TIMER_EXPIRED then
        if alive == "yes" then
            ...
            MovingTrackDrawShip(myRotation, myXThrust, myYThrust)
        else
        ...
        for indx = 1,enemyCount do
            if (timeCounter/myEnemies[indx].REACT) == (math.floor(timeCounter/myEnemies[indx].REACT)) then
                MovingTrackSetTravelDirection(indx, myX + 10, myY + 10)
            end
        end
