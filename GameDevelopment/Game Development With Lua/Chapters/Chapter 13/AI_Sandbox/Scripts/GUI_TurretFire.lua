...
--=======================================
-- filename:  GUI_TurretFire.lua
-- author:    Nick Carlson
-- created:   March 8, 2005
-- descrip:   turret fires at near objects
--=======================================
...
--=======================================
-- function:  TurretFireSetTravelDirection(indx, tX, tY)
...
--=======================================
-- function:  TurretFireDrawShip(myRot, x, y)
-- author:    Paul Schuytema
-- created:   February 1, 2004
-- returns:   nothing (process)
...
--y is the Y coordinate of the player's ship
    ...
    if alive == "yes" then
        TurretFireCasualtyCheck()
    end
end


--=======================================
-- function:  TurretFireDrawTurret(turRot, turX, turY)
-- author:    Paul Schuytema
-- created:   February 1, 2004
-- returns:   nothing (process)
-- descrip:   refreshes the image of the player's ship
...
--=======================================
-- function:  TurretFireProjectileInit()
-- author:    Nick Carlson
-- created:   February 11, 2005
-- returns:   nothing (process)
...
--=======================================
-- function:  TurretFireFireProjectile(ship, xThrust, yThrust)
-- author:    Nick Carlson
-- created:   February 11, 2005
-- returns:   nothing (process)
-- descrip:   creates a projectile and indexs it in myProjectiles table
--=======================================
function TurretFireFireProjectile(xThrust, yThrust)
...
--=======================================
-- function:  TurretFireDrawProjectile()
-- author:    Nick Carlson
-- created:   February 11, 2005
-- returns:   nothing (process)
...
--=======================================
-- function:  TurretFireEnemyHitCheck()
-- author:    Nick Carlson
-- created:   February 11, 2005
-- returns:   nothing (process)
...
--=======================================
-- function:  TurretFireCasualtyCheck()
-- author:    Nick Carlson
-- created:   February 11, 2005
-- returns:   nothing (process)
...
SetEventHandler("TurretFireEvent")


--Event handler
function TurretFireEvent(id, eventCode)

	if (eventCode == GUI_REENTER_INTERFACE)  or (eventCode == GUI_ENTER_INTERFACE) then
        MakeWorld()
        TurretFireSetUp()
        TurretFireEnemyInit()
        TurretFireProjectileInit()
    ...
    if eventCode == GUI_TIMER_EXPIRED then
        if alive == "yes" then
            ...
            TurretFireDrawShip(myRotation, myXThrust, myYThrust)
        else
        ...
        for indx = 1,enemyCount do
            if (timeCounter/myEnemies[indx].REACT) == (math.floor(timeCounter/myEnemies[indx].REACT)) then
                TurretFireSetTravelDirection(indx, myX + 10, myY + 10)
            end
        end
        TurretFireTurretFacing()

        --Updates entities
        TurretFireDrawProjectile()
        DrawEnemyShip()
        TurretFireDrawTurret(turRotation, turX, turY)
        --Checks for various collisions
        TurretFireEnemyHitCheck()
        --Resets the timer
        StartTimer(refreshRate)
    end
end
