...
--=======================================
-- filename:  GUI_Movement.lua
-- author:    Nick Carlson
-- created:   April 15, 2005
-- descrip:   Sprite movement demonstration
--=======================================
...
ItemCommand(GUI_INGAME + 201, "SetString", "Left-Click To Set The Tank In Motion")
...
SetEventHandler("MovementEvent")


--Event handler
function MovementEvent(id, eventCode)
