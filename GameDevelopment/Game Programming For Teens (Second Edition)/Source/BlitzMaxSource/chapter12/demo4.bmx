...
'** Main loop **************************************************************************************
	...
	Repeat
		...
		If enemy.x > WIDTH - ImageWidth(enemy.image) Then
			
			enemy.x = WIDTH - ImageWidth(enemy.image)
		EndIf
		
		If enemy.x < ImageWidth(enemy.image) Then
			
			enemy.x = ImageWidth(enemy.image)
		EndIf
		
		If enemy.y > HEIGHT - ImageHeight(enemy.image) Then
			
			enemy.y = HEIGHT - ImageHeight(enemy.image)
		EndIf
		
		If enemy.y < ImageHeight(enemy.image) Then
			
			enemy.y = ImageHeight(enemy.image)
		EndIf
