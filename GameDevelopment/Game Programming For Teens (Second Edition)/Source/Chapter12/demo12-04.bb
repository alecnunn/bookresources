;demo12-04.bb - Demonstrates evasion algorithms
Graphics 800,600
...
;If the player is above the enemy, move the enemy down
If playery > enemyy
	enemyy = enemyy - ENEMYSPEED
EndIf

;If the player is to the left of the enemy, move the enemy right
If playerx < enemyx
	enemyx = enemyx + ENEMYSPEED
EndIf

;If the player is to the right of the enemy, move the enemy left
If playerx > enemyx
	enemyx = enemyx - ENEMYSPEED
EndIf

;if the player is below the enemy, move the enemy up
If playery < enemyy
	enemyy = enemyy + ENEMYSPEED
EndIf
