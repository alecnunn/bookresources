// IawCube.h App Wizard Version 2.0 Beta 1
// ----------------------------------------------------------------------
// 
 ...
 * A Cube object.
 */
class IawCube : public IawObject
{
public:
  /** Constructor */
  IawCube(DWORD flags = DEFAULTFVF);
  ...
  /**
   * Initialize a Cube.
   * The default parameters are for a cube having no velocity, and centered.
   */
