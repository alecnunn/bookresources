...
// PURPOSE:
//    
// IawShader.cpp: implementation of four classes:
//
//     CIawShader: A container for a shader which contains a description and 
//					one or more implementations
//
//     CIawShaderImplementation: A container for a shader implementation which 
//				   consists of one or more 'components' in a linked list
//     
//     CIawShaderComponent: A linked list element for a component of a shader
//                 implementation. Each component points to it's child, plus 
//                 has a pointer to an 'element'
//
//     CIawShaderElement: A container for a stateblock, vertex shader, matrix
//                 or other component used in the implementation of a shader.
//				   note that only stateblocks are currently implemented
//
//		
// ----------------------------------------------------------------------
...
// Constants... note: we've only implemented State block usage so far
