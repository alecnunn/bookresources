...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "..\..\..\include" /I "..\..\shared" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "GameOfLife_EXPORTS" /Fr /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\..\..\include" /I "..\..\shared" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "GameOfLife_EXPORTS" /FR /YX /FD /GZ /c
...
SOURCE=.\GameOfLife.nvv

!IF  "$(CFG)" == "GameOfLife - Win32 Release"

# Begin Custom Build
InputPath=.\GameOfLife.nvv

"GameOfLife.vso" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	..\..\nvasm.exe GameOfLife.nvv
