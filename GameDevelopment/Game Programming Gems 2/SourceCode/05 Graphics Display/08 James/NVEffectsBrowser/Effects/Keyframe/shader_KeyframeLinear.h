...
#ifndef __SHADER_KEYFRAMELINEAR_H
#define __SHADER_KEYFRAMELINEAR_H
...
class CShaderKeyframeLinear : public EBEffect
{
public:
	CShaderKeyframeLinear();
	~CShaderKeyframeLinear();
...
private:
	...
	void Translate(const D3DXVECTOR3& vec3);
