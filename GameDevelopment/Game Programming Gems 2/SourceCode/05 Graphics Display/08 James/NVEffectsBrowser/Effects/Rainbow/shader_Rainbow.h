...
#ifndef SHADER_Rainbow_H
#define SHADER_Rainbow_H
#include "MouseUI.h"
#include <string>
...
typedef enum tageRainbowDisplayOptions
{
	RainbowDisplay_SILHOUETTES = 0,
	RainbowDisplay_SHADING = 1,
	RainbowDisplay_SILHOUETTESANDSHADING = 2
} eRainbowDisplayOptions;

class CShaderRainbow : public EBEffect
{
public:	
	CShaderRainbow();
	~CShaderRainbow();
...
private:
	...
	eRainbowDisplayOptions m_eDisplayOption;
