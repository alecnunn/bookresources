...
//CHostApplication.
static CHostApplication *g_pHostApplication = NULL; 
...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT)
{
	...
	g_pHostApplication = new CHostApplication();

	//Run until the application returns from Go!
    g_pHostApplication->Go();

	//Clean up the application
	delete (g_pHostApplication);
							  ...
							  WPARAM wParam, LPARAM lParam)
{
	...
	return g_pHostApplication->MessageHandler(hWnd, Message, 
											  wParam, lParam);
}
