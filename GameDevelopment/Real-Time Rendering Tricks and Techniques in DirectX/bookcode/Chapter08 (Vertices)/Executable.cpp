...
//CHostApplication.
static CVertexApplication *g_pVertexApplication = NULL; 
...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT)
{
	...
	g_pVertexApplication = new CVertexApplication();

	//Run until the application returns from Go!
    g_pVertexApplication->Go();

	//Clean up the application
	delete (g_pVertexApplication);
							  ...
							  WPARAM wParam, LPARAM lParam)
{
	...
	return g_pVertexApplication->MessageHandler(hWnd, Message, 
											  wParam, lParam);
}
