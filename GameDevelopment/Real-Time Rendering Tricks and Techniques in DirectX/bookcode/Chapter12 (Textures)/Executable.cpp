...
//CHostApplication.
static CTextureApplication *g_pTextureApplication = NULL; 
...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT)
{
	...
	g_pTextureApplication = new CTextureApplication();

	//Run until the application returns from Go!
    g_pTextureApplication->Go();

	//Clean up the application
	delete (g_pTextureApplication);
							  ...
							  WPARAM wParam, LPARAM lParam)
{
	...
	return g_pTextureApplication->MessageHandler(hWnd, Message, 
											      wParam, lParam);
}
