...
//CHostApplication.
static CTestingApplication *g_pTestingApplication = NULL; 
...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT)
{
	...
	g_pTestingApplication = new CTestingApplication();

	//Run until the application returns from Go!
    g_pTestingApplication->Go();

	//Clean up the application
	delete (g_pTestingApplication);
							  ...
							  WPARAM wParam, LPARAM lParam)
{
	...
	return g_pTestingApplication->MessageHandler(hWnd, Message, 
											          wParam, lParam);
}
