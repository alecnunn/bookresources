...
;Compute the Vector from vertex to eye in object space
;and store the vector in r1
sub r1, c5, v0

;transform eye vector by the transformed basis vectors
dp3 r0.x, v8.xyz,  r1
dp3 r0.y, v9.xyz,  r1
dp3 r0.z, v10.xyz, r1
...
;place it in the range from zero to one and place it in oT2
mad oD1, r0, c6.x, c6.x
