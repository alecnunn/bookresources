...
HRESULT CD3DFont::RestoreDeviceObjects()
{
    ...
    for( UINT which=0; which<2; which++ )
    {
        ...
        if (1)// D3DFONT_ZENABLE & m_dwFontFlags )
...
// Desc: Draws 2D text
//-----------------------------------------------------------------------------
HRESULT CD3DFont::DrawText( FLOAT sx, FLOAT sy, TCHAR* strText, DWORD dwFlags )
{
	 if (!m_bShowText) return S_OK;
