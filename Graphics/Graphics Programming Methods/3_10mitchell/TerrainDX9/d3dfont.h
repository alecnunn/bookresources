...
public:
    ...
    HRESULT DrawText( FLOAT x, FLOAT y,  const TCHAR* strText, 
		 DWORD dwColor=FONT_COL,DWORD dwFlags=0L );
    ...
    HRESULT DeleteDeviceObjects();
	 ...
	 void Toggle_Text_Display() { m_bShowText=!m_bShowText; }
