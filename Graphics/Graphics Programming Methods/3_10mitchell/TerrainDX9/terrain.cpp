...
LPDIRECT3D9	Application::D3D=NULL;
...
static bool wire_frame=false;
	...
	if (wire_frame)
	{
		Font->DrawText(10,240,"W/S - Fill Mode (wireframe)");
	}
	else
	{
		Font->DrawText(10,240,"W/S - Fill Mode (solid)");
	}
...
static bool fog_enable=true;
	...
	if (fog_enable)
	{
		Font->DrawText(10,260,"R/F - Fog (enabled)");
	}
	else
	{
		Font->DrawText(10,260,"R/F - Fog (disabled)");
	}
