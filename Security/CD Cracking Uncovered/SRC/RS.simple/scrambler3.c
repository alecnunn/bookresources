...
// Check fragment of the genuine sequence for testing the program
// -----------------------------------------------------------------------
...
{
	int a, tmp;
	int reg = 0x8001; // first scrambler sequence element

	for(a = 1; a < 1170/* length of scrambler sequence in words*/; a++)
	{
		// printing
		printf_bin(reg);
		if ((a % 8) == 0) printf(".............%03d.................\n",a /8);
		...
		// processing polynomial x^15+x+1, which is equivalent to. 1<<15 + 1<<1 + 1<<0
